...
class DepartmentAM {
    ...
    this.orderTextField.setAttribute(
      {
        "type": "text",
        "class": "global_input",
        "placeholder": Module.getMethodParameterRuleObj(this.source.departmentRule, "addDepartment", "order").format_prompt,
        "style": "width: -webkit-fill-available;"
      }
    );
    ////////////////////////////////////////////////////////////////////////////
  ...
  frozenControl(name) {
    ...
    this.formList.getObject().find("table").find("tbody").find("tr").find("td").find(":checkbox").attr("disabled", "disabled");
  ...
  recoverControl(name) {
    ...
    if (this.queue.isEmpty()) {
      ...
      this.formList.getObject().find("table").find("tbody").find("tr").find("td").find(":checkbox").removeAttr("disabled");
  ...
  resetControl() {
    ...
    this.formList.getObject().find("table").find("tbody").find("tr").find("td").find(":checkbox").prop("checked", false);
  }
}
