...
class AdminFilter {
  ...
  generateCode() {
    ...
    this.nameTextField.setAttribute(
      {
        "type": "text",
        "class": "global_input",
        "placeholder": Module.getMethodParameterRuleObj(this.source.adminRule, "getAdmin", "name").format_prompt,
    ...
    list.push({"attr": {}, "required": false, "label_code": `${this.roleNameLabel.getCode()}`, "control_id": `${this.roleNameSelect.getId()}`, "control_code": `${this.roleNameSelect.getCode()}`});
