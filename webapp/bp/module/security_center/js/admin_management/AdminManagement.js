...
class AdminManagement {
          ...
          for (let i = 0; i < source.adminObj.array.length; i++) {
            ...
            code += `
              <tr>
                ...
                <td class = "operation" data-uuid = "${admin.uuid}"><span class = "modify">修改</span><span class = "remove">删除</span></td>
              </tr>
            `;
          }
  ...
  addAdminAMConfirmButtonClickEvent(event) {
    ...
    Network.request(Network.RequestType.POST, Network.ResponseType.JSON, [{"Content-Type": "application/x-www-form-urlencoded"}],
      Configure.getServerUrl() + "/module/security.Admin/addAdmin", parameterArray, source,
  ...
  modifyAdminAMConfirmButtonClickEvent(event) {
    ...
    ////////////////////////////////////////////////////////////////////////////
    Network.request(Network.RequestType.POST, Network.ResponseType.JSON, [{"Content-Type": "application/x-www-form-urlencoded"}],
      Configure.getServerUrl() + "/module/security.Admin/modifyAdmin", parameterArray, source,
      function loadStart(xhr, xhrEvent, source) {
  ...
  adminFilterConfirmButtonClickEvent(event) {
    ...
    ////////////////////////////////////////////////////////////////////////////
    Network.request(Network.RequestType.POST, Network.ResponseType.JSON, [{"Content-Type": "application/x-www-form-urlencoded"}],
      Configure.getServerUrl() + "/module/security.Admin/getAdmin", parameterArray, source, "getAdmin"); 
  }
  ...
  removeConfirmWindowConfirmButtonClickEvent(event) {
    ...
    ////////////////////////////////////////////////////////////////////////////
    Network.request(Network.RequestType.POST, Network.ResponseType.JSON, [{"Content-Type": "application/x-www-form-urlencoded"}],
      Configure.getServerUrl() + "/module/security.Admin/removeAdmin", parameterArray, source,
      function loadStart(xhr, xhrEvent, source) {
  ...
  getAdmin() {
    ...
    ////////////////////////////////////////////////////////////////////////////
    Network.request(Network.RequestType.POST, Network.ResponseType.JSON, [{"Content-Type": "application/x-www-form-urlencoded"}],
      Configure.getServerUrl() + "/module/security.Admin/getAdmin", parameterArray, this, "getAdmin");
  }
